 ...
 */
final class Version20220906200520 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_8D93D649F08F511D ON user (user_settings_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_8D93D649F08F511D ON user');
